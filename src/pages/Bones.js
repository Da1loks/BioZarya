...
import { Box, Typography, Container, Grid, Card, CardContent, CardMedia, List, ListItem, ListItemIcon, ListItemText, Modal, IconButton } from '@mui/material';
...
const Bones = () => {
  ...
  const handleOpenImage = (imageSrc) => {
    ...
    setImageScale(1); // Сбрасываем масштаб при открытии новой картинки
  ...
  const handleZoomIn = () => {
    ...
    // При изменении масштаба сбрасываем позицию для предотвращения неожиданных эффектов
  ...
  const handleMouseDown = (e) => {
    // Начало перетаскивания только при левой кнопке мыши
    if (e.button === 0) {
      setIsDragging(true);
  ...
  // Добавляем обработчики событий при монтировании и удаляем при размонтировании
  useEffect(() => {
    if (openImageModal) {
  ...
  }, [openImageModal, isDragging, dragStart]);
            ...
            <Grid item xs={12} md={6}>
              <Card>
                <Box
                  ...
                  onClick={() => handleOpenImage('/images/systems/vertebra.png')}
                >
                  <img 
            ...
            <Grid item xs={12} md={6}>
              <Card>
                <Box
                  ...
                  onClick={() => handleOpenImage('/images/bones/stroenie-kostei-cheloveka.jpg')}
                >
                  <img 
              ...
              <Card>
                <CardContent>
                  ...
                  <List>
                    ...
                    <ListItem>
                      <ListItemIcon>•</ListItemIcon>
                      <ListItemText primary="Регулярно употребляйте продукты, богатые витамином K (зеленые листовые овощи, брокколи, капуста), который участвует в минерализации костной ткани" />
                    </ListItem>
                  </List>
                </CardContent>
              </Card>
            ...
            >
              ...
              >
                ...
                <IconButton 
                  ...
                  sx={{ color: 'white', bgcolor: 'rgba(255,255,255,0.1)', '&:hover': { bgcolor: 'rgba(255,255,255,0.2)' } }}
                >
                  <Typography variant="body1">Центр</Typography>
                </IconButton>
                <IconButton 
                  onClick={handleCloseImage} 
                  sx={{ color: 'white', bgcolor: 'rgba(255,255,255,0.1)', '&:hover': { bgcolor: 'rgba(255,255,255,0.2)' } }}
